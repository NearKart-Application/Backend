...
urlpatterns = [
    ...
    path('<uuid:video_id>/comments/',                        VideoCommentView.as_view(),         name='video-comments'),
    path('<uuid:video_id>/comments/<int:comment_id>/',       VideoCommentDeleteView.as_view(),   name='video-comment-delete'),
]
