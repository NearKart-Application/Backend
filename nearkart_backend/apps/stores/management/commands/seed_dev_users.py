...
DEV_VENDOR_STORES = {
    ...
    '+919999999999': {
        'name': 'Dev Test Store',
        'category': 'other',
        'description': 'Legacy dev bypass store used for general testing.',
        'address': 'Test Address, Kukatpally, Hyderabad',
        'locality': 'Kukatpally',
        'lat': 17.4950, 'lng': 78.3994,
        'logo':   'https://picsum.photos/seed/dev-legacy-logo/200/200',
        'banner': 'https://picsum.photos/seed/dev-legacy-banner/800/300',
        'offer': None,
        'products': [
            ('Test Product Alpha',  'other', 'test', 100, None, ['S', 'M', 'L']),
            ('Test Product Beta',   'other', 'test', 200, 150,  []),
            ('Test Product Gamma',  'other', 'test', 300, None, ['One Size']),
        ],
    },
}
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        rows = [
            ...
            ('Dev Vendor',    '+919999999999', '999999', 'vendor → Dev Test Store'),
