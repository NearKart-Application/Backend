...
@shared_task(bind=True, name='products.notify_price_drops', max_retries=2, default_retry_delay=60, time_limit=300, soft_time_limit=270)
def notify_price_drops(self):
    try:
        ...
        logger.error('[products] notify_price_drops failed, retrying: %s', exc)
